        ...
        <CardBody>
          <Row>
            ...
            <Col md='9' lg='6' className='mb-2'>
              <img width='100%' src={this.state.demoMovie.videoSrcDesktop} alt='demo desktop video' />
            </Col>
            <Col xs='8' sm='8' md='3' lg='2' className='mb-2 mx-auto'>
              <img width='100%' src={this.state.demoMovie.videoSrcMobile} alt='demo mobile video' />
            </Col>
          </Row>
        </CardBody>
      </Card>
